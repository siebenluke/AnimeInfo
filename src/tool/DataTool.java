...
public final class DataTool {
    ...
    /**
     * Converts a string list to a string with its elements separated by new line separators.
     *
     * @param list the list
    ...
    /**
     * Converts a string list to a string with its elements separated by a separator.
     *
     * @param list      the list
     * @param separator the separator
     * @return the separated string list or null
